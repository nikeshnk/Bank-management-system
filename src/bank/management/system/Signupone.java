...
public class Signupone extends JFrame implements ActionListener {
    ...
    Signupone(){
        ...
        JLabel personDetails = new JLabel("Page 1: Perssonal Details");
        ...
        dateChooser.setFont(new Font("Raleway",Font.ITALIC, 15));
        add(dateChooser);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                Conn c = new Conn();
                String query = "Insert into signup values('"+formno+"' ,'"+name+"' ,'"+fname+"' ,'"+dob+"' ,'"+gender+"','"+marital+"' ,'"+city+"' ,'"+state+"' ,'"+pincode+"' ,'"+email+"' ,'"+address+"')";
